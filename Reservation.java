...
public class Reservation {
    ...
    public static void main(String args[]) {
        ...
        // Ask user for a window or an cooridor seat and store their choice.

        System.out.print("Please enter 1 for window, 2 for corridor, or 0 to exit: ");
        ...
        while (choice != 0) {
            ...
            if (choice == 1) {
                ...
                // No window seats available, try booking an cooridor seat for them instead.
                ...
                // If they chose booking an cooridor, check to see if it is available.
                ...
                if (seatnumber == -1) {
                    ...
                    // Booking an cooridor seat was successful.
            ...
            // No window or cooridor seats were available.
            ...
            System.out.print("Please enter 1 for window, 2 for cooridor, or 0 to exit: ");
